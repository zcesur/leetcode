...
import           Data.Graph.Inductive (Gr, Node, LNode, LEdge, match)
...
parse :: [[String]] -> [Float] -> ([LNode String],[LEdge Float],Map String Int)
